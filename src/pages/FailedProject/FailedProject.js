...
import {createProject, deleteProject} from '../../api/index.js';
import classNames from 'classnames';
import styles from './FailedProject.scss';
import { useAuth0 } from '@auth0/auth0-react';

const FailedProject = (props) => {
  ...
  useEffect(() => {
    ...
    if(get_project.retrievedProject){
      setTitle(get_project.retrievedProject.projectTitle);
      setTabValue(String(get_project.retrievedProject.requestType+1));
      setSelectedLanguages(get_project.retrievedProject.translatedLanguages.map(language=>({name:language, code:language})));
      setSelectedOriginal({name:get_project.retrievedProject.originalLanguage, code:get_project.retrievedProject.originalLanguage});
      setSpeakers({name:get_project.retrievedProject.speakers, code:get_project.retrievedProject.speakers});
    }
  },[get_project]);
  ...
  const submitProject = async () => {
    ...
    try {
      ...
      await trackPromise(deleteProject(project_id));
    } catch (error) {
    ...
    {project.retrievedProject &&
      <div className={styles.newProject}>
        <div className={styles.subHeader}>
          <p className={styles.title}>Repair Project</p>
        ...
        <div className={styles.main}>
          <div className={styles.content}>
            ...
            <MyDropzone showError={showError} selectedFile={selectedFile} SetSelectedFile={SetSelectedFile}/>
          </div>
          <div className={styles.content}>
